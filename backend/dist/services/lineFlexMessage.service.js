 ...
 */
function buildFlexMessage(template, data) {
    switch (template) {
 ...
 */
function buildBillNotification(data) {
 ...
 */
function buildBillOverdue(data) {
 ...
 */
function buildBillSummary(data) {
 ...
 */
function buildMaintenanceConfirmation(data) {
 ...
 */
function buildQuickReplyMenu(_data) {
    return {
        type: 'bubble',
        body: {
            type: 'box',
...
//# sourceMappingURL=lineFlexMessage.service.js.map