...
exports.generateMonthlyBills = exports.getOverdueBills = exports.updateBillStatus = exports.createBill = exports.getBillById = exports.getBills = void 0;
 ...
 */
exports.getBills = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { tenantId, roomId, status, billingMonth, overdue, page = '1', limit = '20', } = req.query;
    ...
    if (billingMonth) {
        const month = new Date(billingMonth);
 ...
 * @param res - Express response
 */
exports.getBillById = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
 ...
 */
exports.createBill = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const result = await prisma.$transaction(async (tx) => {
        ...
        // Create bill items
        const billItems = await Promise.all(finalItems.map((item) => tx.billItem.create({
            data: {
                billId: bill.id,
    ...
    logger_1.logger.info(`Bill created: ${result.billNumber}`, {
        billId: result.id,
        tenantId,
 ...
 * @param res - Express response
 */
exports.updateBillStatus = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    ...
    logger_1.logger.info(`Bill status updated: ${bill.billNumber}`, {
        billId: id,
        status,
 ...
 * @param res - Express response
 */
exports.getOverdueBills = (0, errorHandler_1.asyncHandler)(async (_req, res) => {
 ...
 */
exports.generateMonthlyBills = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    for (const tenant of tenants) {
        ...
        try {
            ...
            logger_1.logger.error(`Failed to create auto-bill for tenant ${tenant.id}`, err);
        }
    }
    res.json({
        success: true,
