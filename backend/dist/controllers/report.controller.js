...
exports.exportOverdueReport = exports.exportRevenueReport = exports.exportOccupancyReport = exports.getOverdueSummary = exports.getRevenueReport = exports.getOccupancyReport = void 0;
 ...
 */
exports.getOccupancyReport = (0, errorHandler_1.asyncHandler)(async (_req, res) => {
 ...
 * @param res - Express response
 */
exports.getOverdueSummary = (0, errorHandler_1.asyncHandler)(async (_req, res) => {
 ...
 */
exports.exportOccupancyReport = (0, errorHandler_1.asyncHandler)(async (_req, res) => {
    const buildings = await prisma.building.findMany({
 ...
 */
exports.exportRevenueReport = (0, errorHandler_1.asyncHandler)(async (req, res) => {
 ...
 */
exports.exportOverdueReport = (0, errorHandler_1.asyncHandler)(async (_req, res) => {
    const overdueBills = await prisma.bill.findMany({
        where: {
            status: 'pending',
            dueDate: { lt: new Date() },
