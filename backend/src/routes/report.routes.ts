 ...
 * @access  Private (Admin only)
 */
router.get('/overdue-summary', authenticate, authorize(['admin']), getOverdueSummary);
 ...
 */
router.get('/occupancy/export', authenticate, authorize(['admin']), exportOccupancyReport);
 ...
 * @query   startDate, endDate, format
 */
router.get('/revenue/export', authenticate, authorize(['admin']), exportRevenueReport);
 ...
 * @query   format
 */
router.get('/overdue/export', authenticate, authorize(['admin']), exportOverdueReport);
