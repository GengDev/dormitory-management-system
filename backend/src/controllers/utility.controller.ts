...
export const getUtilities = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  if (recordMonth) {
    const month = new Date(recordMonth as string);
 ...
 * @param res - Express response
 */
export const getUtilityById = asyncHandler(async (req: AuthRequest, res: Response) => {
  const { id } = req.params;
...
export const createUtility = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const waterUsage =
    waterCurrentReading && waterPreviousReading
  ...
  logger.info(`Utility record created for room ${room.roomNumber}`, {
 ...
 * @param res - Express response
 */
export const updateUtility = asyncHandler(async (req: AuthRequest, res: Response) => {
  const { id } = req.params;
  ...
  if (updateData.waterCurrentReading || updateData.waterPreviousReading) {
    const waterUsage =
      updateData.waterCurrentReading && updateData.waterPreviousReading
  ...
  if (updateData.electricityCurrentReading || updateData.electricityPreviousReading) {
    const electricityUsage =
      updateData.electricityCurrentReading && updateData.electricityPreviousReading
  ...
  logger.info(`Utility record updated: ${id}`, {
    utilityId: id,
 ...
 * @param res - Express response
 */
export const deleteUtility = asyncHandler(async (req: AuthRequest, res: Response) => {
  const { id } = req.params;
  ...
  logger.info(`Utility record deleted: ${id}`, {
    utilityId: id,
