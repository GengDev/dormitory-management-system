...
export const createNotification = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const notification = await prisma.notification.create({
    data: {
      ...
      title,
      message,
      notificationType: (type as NotificationType) || NotificationType.general,
      status: 'pending',
      data: metadata || {}
    }
  });
 ...
 */
export const sendBillNotification = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  await prisma.notification.create({
    data: {
      ...
      notificationType: NotificationType.bill_created,
      status: 'pending',
      data: {
        billId: bill.id,
 ...
 */
export const sendMaintenanceNotification = asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
export const sendCustomNotification = asyncHandler(async (req: AuthRequest, res: Response) => {
